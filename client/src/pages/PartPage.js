  ...
  return (
    <div className="PartPage -mt-16">
      ...
      <div className="container mx-auto">
        <ImagesWithTitle title="덱 (Deck)" images={[deck1, deck2]} bgColor={'none'} />
        <ImagesWithTitle title="트럭 (Truck)" images={[truck1]} bgColor={'none'} />
        <ImagesWithTitle title="휠 (Wheel)" images={[wheel1, wheel2]} bgColor={'none'} />
        <ImagesWithTitle title="기타 부품 (ETC)" images={[etc1, etc2, etc3]} bgColor={'none'} />
      </div>
    </div>
  );
}
